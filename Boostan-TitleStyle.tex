...
%\geometry{paperwidth=280mm,paperheight=200mm,rmargin=0mm,lmargin=0mm,top=0mm,bottom=0mm}
...
\DeclareDocumentCommand{\Godpage}{g g}{	
	...
	\IfValueTF{#1}{
		...
		\IfValueTF{#2}{
			\defpersianfont\salam[Scale=26]{Far.Symbol8}
			{\salam #2}
		}{%%%
			\defpersianfont\salam[Scale=50]{Far.Symbol8}
			{\salam c}
...
\DeclareDocumentCommand{\GodpageFont}{g}{	
	\thispagestyle{empty}
	\begin{center}
		\IfValueTF{#1}{
			\defpersianfont\salam[Scale=26]{Far.Symbol8}
...
\defpersianfont\salam[Scale=12]{Far.Symbol8}


\newcommand{\presStyle}[1]{
	\defpersianfont\titr[Scale=1.2]{IRTitr}
...
\ifthenelse{\equal{\@titleStyle}{presentation}}{\presStyle{b}}{ %4
