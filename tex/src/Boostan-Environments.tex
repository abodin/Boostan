	...
	\begin{center}
		\begin{tikzpicture}
			...
			\IfValueTF{#2}{
				...
				\IfFileExists{\MyPath images/icon/note.png}{\begin{minipage}{.85\textwidth}}{\begin{minipage}{.93\textwidth}}
			}%%
				\begin{RTL}
}{%
				\end{RTL}
			...
			\IfValueTF{#2}{
				...
				\IfFileExists{\MyPath images/icon/note.png}
				{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/note}}; }
				{\node[fancytitle2,  rounded corners] at (box.west) {\handBS};}
			}%%
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\IfValueTF{#2}{
				...
				\IfFileExists{\MyPath images/icon/archeryf.pdf}{\begin{minipage}{.85\textwidth}}{\begin{minipage}{.93\textwidth}}
			}%%
				\begin{RTL}
}{%
				\end{RTL}
			...
			\IfValueTF{#2}{
				...
				\IfFileExists{\MyPath images/icon/archeryf.pdf}
				{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/archeryf}}; }
				{\node[fancytitle2,  rounded corners] at (box.west) {\treeBS};}
			}%%
		\end{tikzpicture}
	\end{center}
...
\NewDocumentEnvironment{warning}{g g}{
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/warining.png}{\begin{minipage}{.85\textwidth}}{\begin{minipage}{.93\textwidth}}
	}%%
		\begin{RTL}
}{%
		\end{RTL}
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/warining.png}
		{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/warining.png}}; }
		{\node[fancytitle2,  rounded corners] at (box.west) {\arcBS};}
	}%%
	\end{tikzpicture}
	\end{center}
...
\NewDocumentEnvironment{refer}{g g}{
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/referO.png}{\begin{minipage}{.85\textwidth}}{\begin{minipage}{.93\textwidth}}
	}%%
	\begin{RTL}
}{%
	\end{RTL}
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/referO.png}
		{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/referO}}; }
		{\node[fancytitle2,  rounded corners] at (box.west) {\envBS};}
	}%%
	\end{tikzpicture}
	\end{center}
...
\NewDocumentEnvironment{info}{g g}{
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/infoRR.png}{\begin{minipage}{.85\textwidth}}{\begin{minipage}{.93\textwidth}}
	}%%
	\begin{RTL}
}{%
	\end{RTL}
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/infoRR.png}
		{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/infoRR}}; }
		{\node[fancytitle2,  rounded corners] at (box.west) {\twoBS};}
	}%%
	\end{tikzpicture}
	\end{center}
...
\NewDocumentEnvironment{problem}{g g}{
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/home.png}{\begin{minipage}{.85\textwidth}}{\begin{minipage}{.93\textwidth}}
	}%%
	\linespread{1.5}
	\begin{RTL}
}{%
	...
	\IfValueTF{#2}{
		...
		\IfFileExists{\MyPath images/icon/home.png}
		{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/home}}; }
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\IfValueTF{#2}{
				...
				\IfFileExists{\MyPath images/icon/defi.png}
				{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/defi}}; }
				{\node[fancytitle2,  rounded corners] at (box.west) {\defBS};}
			}%%
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\IfValueTF{#2}{
				...
				{\node[fancytitle3, left=3pt,   rounded corners] at (box.west) {\includegraphics[width=.07\textwidth]{\MyPath images/icon/robah}}; }
				{\node[fancytitle2,  rounded corners] at (box.west) {\commentBSS};}
			}%%
		\end{tikzpicture}
	\end{center}
...
\makeatletter
\newcommand{\boxedT}[2]{%
\tikz[baseline]\node [rectangle, minimum width=1ex,rounded corners=3mm,draw,fill=#1,draw=none,anchor=base] {#2};}
 \makeatother
