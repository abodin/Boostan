...
% با دستور زیر می توانید فونتی مخصوص عبارات فارسی تعیین کنید:
	...
	\ifthenelse{\equal{\@docStyle}{Pres}}   {\settextfont[Scale=1.25]{IRNazanin}}{
	\ifthenelse{\equal{\@docStyle}{Article}}{\settextfont[Scale=1.25]{IRNazanin}}{}}
	}
...
% دقت کنید که عبارات انگلیسی شما باید در دستور \lr{} قرار گیرد تا xepersian بتواند بفمهد که این عبارات انگلیسی است
	...
	\ifthenelse{\equal{\@docStyle}{Pres}}   {\setlatintextfont[Scale=1.1]{Linux Libertine}}{
	\ifthenelse{\equal{\@docStyle}{Article}}{\setlatintextfont[Scale=1.1]{Linux Libertine}}{}}
	}
