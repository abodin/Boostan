...
\newif\ifrandomize
\randomizetrue  % فعالسازی تصادفیسازی (پیشفرض)
%\randomizefalse % غیرفعالسازی تصادفیسازی
